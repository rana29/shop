        ...
        <div class="panel-content">
            <div class="row">
                ...
                <div class="col-xs-6 text-right">
                   <a class="btn btn-primary " href="{{route('index-catagory')}}">Add catagory</a> 
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{route('edit-catagory',$row->id)}}" class="btn btn-success btn-xs"><i class="fa fa-pencil"></i></a>
                                               ...
                                               <div class="modal fade" id="rana{{$row->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                  ...
                                                  <div class="modal-body">
                                                    <form method="post" action="{{route('catagory-delete',$row->id)}}">
                                                      @csrf
