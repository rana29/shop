...
<div class="content-header">
    ...
    <div class="leftside-content-header">
        <ul class="breadcrumbs">
            ...
            <li><a href="javascript:avoid(0)">Manage-subcatagory</a></li>
        </ul>
    </div>
</div>
<!-- =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-= -->
    ...
    <div class="col-sm-12 col-md-8 col-md-offset-2">
     ...
     <div class="panel b-primary bt-md">
        <div class="panel-content">
            <div class="row">
                <div class="col-xs-6">
                    <h4 class="text-success">Manage subcatagory</h4>
                </div>
                <div class="col-xs-6 text-right">
                   <a class="btn btn-primary " href="{{route('subcatagory-index')}}">Add subcatagory</a> 
                    ...
                    <table id="basic-table" class="data-table table table-striped table-hover table-bordered" cellspacing="0" width="100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$row->cat->catagory}}</td>
                                <td>{{$row->sub_catagory}}</td>
                                ...
                                <td>
                                    ...
                                    <a href="{{route('subcatagory-edit',$row->id)}}" class="btn btn-success btn-xs"><i class="fa fa-pencil"></i></a>
                                    ...
                                    <a href="#rana{{$row->id}}" data-toggle="modal" class="btn btn-success btn-xs "><i class="fa fa-trash"></i></a>
                                               ...
                                               <div class="modal fade" id="rana{{$row->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                  ...
                                                  <div class="modal-body">
                                                    <form method="post" action="{{route('subcatagory-delete',$row->id)}}">
                                                      @csrf
